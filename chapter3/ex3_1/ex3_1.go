// Exercise 3.1: If the function f returns a non-finite float64
// value, the SVG file contain invalid <polygon> elements (although many
// SVG renders handle this gracefully). Modify the program to skip invalid
// polygons.
